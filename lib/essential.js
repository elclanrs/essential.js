...
where = λ(function(match, xs) {
  var find;
  find = λ(function(match, obj) {
    return Object.keys(obj).every(function(k) {
      if (typeof obj[k] === 'object' && typeof match[k] === 'object') {
